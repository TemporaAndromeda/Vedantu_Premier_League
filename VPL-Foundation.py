...
df1 = pd.read_csv("psc_hybrid_data_requirements_user_session_ay_2022_2022-07-28T08_54_22.739974Z.csv",
...
df_exclude = df1.loc[df1["groupname"].str.startswith(f"AakarFoundation-Eng-10-{batch_alphabet}-22-23")]
...
df2 = pd.read_csv("wavebook_id_for_session_id___date_range_filter____coe_2022-07-28T08_07_02.917936Z.csv",
...
Assignment_attempt = pd.read_csv("assignment_attempt_data__filter___batchid_or_date___coe_2022-07-28T08_54_25.908617Z.csv",
...
df_assignment_csv.to_csv(f"Assignment_Foundation-A_{date1_in}_to_{date2_in}.csv")
...
test = pd.read_csv("assignments___test_attempts_ay_2022_23_2022-07-28T08_54_28.963018Z.csv",
...
df_final.to_csv(f"Result_Foundation-A_{date1_in}_to_{date2_in}.csv", index=False)
print("Thank You")